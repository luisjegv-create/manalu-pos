    ...
    const htmlContent = `
        ...
        <body>
            ...
            <div class="footer">
                ...
                Gracias por confiar en Manalú "La Taberna".<br>
...
export const printEventInventoryA4 = (inventoryItems, companyInfo = {}) => {
    ...
    const htmlContent = `
        ...
        <body>
            ...
            <div class="footer">
                Manalú "La Taberna" | El cliente declara recibir los elementos listados en perfecto estado y se compromete a su devolución en idénticas condiciones.
                <br>www.manalulataberna.es
            </div>
...
export const printDailyTicketReport = (stats, categoryStats, periodProducts, periodInfo, companyInfo = {}) => {
    ...
    const htmlContent = `
        ...
        <body>
            ...
            <div class="footer">
                * FIN DE INFORME *<br>
                SISTEMA GESTIÓN MANALÚ "LA TABERNA"
            </div>
